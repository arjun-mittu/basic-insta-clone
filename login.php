	...
	<form method="post" action="loginsave.php">
		<div class="container">
			<div class="row">
				...
				<div class="col-5">
					<div style="background:white;border:solid #E7E5DA 2px;margin-top:100px;margin-bottom:20px;">
						<div style="font-family:arial; font-size:45px;padding-left:18px;padding-top:30px;font-family:Lucida Handwriting;">
							photo-book
										...
										<table border="0" cellpadding="3" cellspacing="7" style="padding-left:35px;padding-top:20px;padding-bottom:10px;">
											...
											<tr>
												<td><input type="submit" value="Log in" style="background:#50B1DC; color:white; width:250px; height:30px;"></td>
					...
					<div style="background:white;border:solid #E7E5DA 2px;margin-top:20px;">
						<p style="margin-top:25px; margin-left:70px;margin-bottom:25px;">
							Don't have an account? <a href="add1.php" style="text-decoration:none; color:blue;"> sign up </a>
						</p>
					</div>
