<html>
	...
	<body>
	<form method="post" action="save1.php" enctype="multipart/form-data" onsubmit="return password1();">
		<div class="container">
			<div class="row">
				<div class="col-7">
						...
						<hr style="color:#B8BBC1;width:300px; align:center;">
										<table border="0" cellpadding="3" cellspacing="7" style="padding-left:35px;padding-top:20px;padding-bottom:10px;">
											...
											<tr>
												...
												<td><input type ="text" placeholder="enter your full name" required name="full_name"style="height:30px;text-align:center;width:250px;border:solid #DBDEE4 1px;border-radius:5px;"></td>
					 						</tr>
											
											<tr>
												
												<td><input type="text" placeholder="user name" name="user_name" required style="height:30px;text-align:center;width:250px;border:solid #DBDEE4 1px;border-radius:5px;"></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="password" placeholder="password" id="pw"  name="password"style="height:30px;text-align:center;width:250px;border:solid #DBDEE4 1px;border-radius:5px;"></td>
											</tr>
											
											<tr>
												<td><input type="submit" value="sign up" style="background:#50B1DC; color:white; width:250px; height:30px;"></td>
	...
	<script>
	 function password1()
	 {
		 var len=document.getElementById("pw").value.length;
		 if(len<6)
		 {
